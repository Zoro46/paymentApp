...
class Profile_page extends StatefulWidget {
  ...
  @override
  State<Profile_page> createState() => _Home_PageState();
}

class _Home_PageState extends State<Profile_page> {
  @override
        ...
        child: Container(
          child: Stack(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(12.0,12.0,10.0,0),
                child: Container(
                  // height: 310.0,
                  width: 460.0,
                  decoration: BoxDecoration(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.asset('assets/images/profile_page_images/anya.jpeg',
                                    fit: BoxFit.fill,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Image.asset('assets/images/profile_page_images/mastercard_icon.png',height: 60.0, width: 60.0,),
                            )
                          ],
                        ),
                              ...
                              child: Column(
                                children: [
                                  Padding(
                                    ...
                                    child: CircleAvatar(
                                      backgroundColor: Color(0xfff1efef),
                                      child: Image.asset('assets/images/profile_page_images/invoice_image.png',fit: BoxFit.cover, height: 20.0, width: 20.0,),
                                      radius: 25.0,
                                    ),
                                  ),
                                  SizedBox(height: 4.0,),
